 ...
 * <p/>
 * This is the final version of the GlassPane it is transparent for MouseEvents,
 * and respects underneath component's cursors by default, it is also friendly
 * for other users, if someone adds a mouseListener to this GlassPane or set a
 * new cursor it will respect them
 *
...
public class GlassPane extends JPanel implements AWTEventListener {
    ...
    /**
     * Note: don't call getHintPos() before setting baloonwidth and baloonheight
    ...
    /**
     * Test if the mouse touches last known shape location, and repaints if so.
     */
