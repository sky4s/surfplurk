...
public class TestApp extends JFrame {
    ...
    public TestApp() {
        ...
        group.add(third);
        menu.add(third);
        JRadioButtonMenuItem fourth =
                new JRadioButtonMenuItem(new ChangeGlassPaneAction("My glassPane", new MyGlassPanel()));
        fourth.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_4, InputEvent.ALT_MASK));
        group.add(fourth);
        menu.add(fourth);

        GlassPane glassPane = new GlassPane(this);
        glassPane.setShowHint(true);
        JRadioButtonMenuItem fifth =
                new JRadioButtonMenuItem(new ChangeGlassPaneAction("GlassPane", glassPane));
        fifth.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_5, InputEvent.ALT_MASK));
        group.add(fifth);
        menu.add(fifth);
...
//        secondFrame.setDoubleBuffered(true);
        pane.add(secondFrame);
        add(pane);
        setSize(650, 350);
        setLocationRelativeTo(null);

//         glassPane.setViewPorts(pane, pane);
    }
