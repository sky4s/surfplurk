...
public class ProxyDetector {
    ...
    public static void main(String[] args) {
        ProxyDetector instance = ProxyDetector.getInstance();
//        System.out.println(instance);
//        System.out.println(instance.determineProxy());
        System.out.println(instance.directConnectionAvailable());
        System.out.println(instance.getHostname());
        System.out.println(instance.getPort());
        System.out.println(instance.proxyDetected());
    ...
    /**
     * Find the proxy, use the property
     * <code>java.net.useSystemProxies</code> to force the usage of the system
     * proxy. The value of this setting is restored afterwards.
     *
